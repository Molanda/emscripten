...
def metadce(js_file, wasm_file, minify_whitespace, debug_info):
  ...
  if settings.MAIN_MODULE:
    ...
    # This means that any usages of data symbols with in the JS or in the side modules can/will keep
    # these exports alive on the wasm module.
    # This importand today for weak data symbols that are defined by the main and the side module
